...
This folder provides easy to understand code snippets on how to get started with [iris](https://github.com/alphayan/iris) micro web framework.
...
- [POC: Isomorphic react/hot reloadable/redux/css-modules starter kit](https://github.com/alphayan/iris-starter-kit)
...
which are filled by its `BeginRequest`, [here](https://github.com/alphayan/iris/blob/master/mvc/session_controller.go).
...
where [mvc.Result](https://github.com/alphayan/iris/blob/master/mvc/func_result.go) is an interface which contains only that function: `Dispatch(ctx iris.Context)`.
...
https://github.com/alphayan/iris/tree/master/middleware#third-party-handlers
...
iris cache library lives on its own [package](https://github.com/alphayan/iris/tree/master/cache).
...
iris session manager lives on its own [package](https://github.com/alphayan/iris/tree/master/sessions).
...
iris websocket library lives on its own [package](https://github.com/alphayan/iris/tree/master/websocket).
...
typescript automation tools have their own repository: [https://github.com/alphayan/iris/tree/master/typescript](https://github.com/alphayan/iris/tree/master/typescript) **it contains examples**

> I'd like to tell you that you can use your favourite but I don't think you will find such a thing anywhere else.

### Hey, You

Developers should read the [godocs](https://godoc.org/github.com/alphayan/iris) and https://docs.iris-go.com for a better understanding.

Psst, I almost forgot; do not forget to [star or watch](https://github.com/alphayan/iris/stargazers) the project in order to stay updated with the latest tech trends, it never takes more than a second!
