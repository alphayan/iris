...
[View or download sample code](https://github.com/alphayan/iris/tree/master/_examples/websocket).
...
* import the `"github.com/alphayan/iris/websocket"`
...
```go
import "github.com/alphayan/iris/websocket"
```
