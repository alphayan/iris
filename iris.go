...
import (
	...
	"github.com/alphayan/iris/core/maintenance"
	"github.com/alphayan/iris/core/netutil"
	"github.com/alphayan/iris/core/router"
	// handlerconv conversions
	"github.com/alphayan/iris/core/handlerconv"
	// cache conversions
	"github.com/alphayan/iris/cache"
	// view
	"github.com/alphayan/iris/view"
	// middleware used in Default method

	requestLogger "github.com/alphayan/iris/middleware/logger"
...
var (
	...
	//
	//
	// Examples: https://github.com/alphayan/iris/tree/master/_examples/file-server
	...
	//
	// Examples can be found at: https://github.com/alphayan/iris/tree/master/_examples/#caching
	Cache = cache.Handler
)
...
//
// Example: https://github.com/alphayan/iris/tree/master/_examples/file-server/single-page-application
...
// https://github.com/alphayan/iris/blob/master/_examples/http-listening/notify-on-shutdown/main.go
