...
//
// Example: https://github.com/alphayan/iris/tree/master/_examples/http-listening/listen-addr/omit-server-errors
...
type Configuration struct {
	...
	// Change to false it if you want something like this https://github.com/alphayan/iris/issues/135 to work
	//
	...
	// currently we have only one: https://github.com/alphayan/iris/tree/master/middleware/i18n.
	//
