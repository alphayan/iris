...
// import "github.com/alphayan/iris/mvc" and read its docs among with its new features at:
// https://github.com/alphayan/iris/blob/master/HISTORY.md#mo-01-jenuary-2018--v1000
func (app *Application) Controller(relPath string, c interface{}, _ ...interface{}) []*router.Route {
	...
	panic(fmt.Errorf(`"Controller" method is DEPRECATED, use the "mvc" subpackage instead.
        ...
        https://github.com/alphayan/iris/blob/master/HISTORY.md#mo-01-jenuary-2018--v1000`, // v10.0.0, we skip the number 9.
