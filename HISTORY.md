...
**How to upgrade**: Open your command-line and execute this command: `go get -u github.com/alphayan/iris` or let the automatic updater do that for you.
...
> The new version adds 75 plus new commits, the PR is located [here](https://github.com/alphayan/iris/pull/849) read the internal changes if you are developing a web framework based on Iris. Why 9 was skipped? Because.
